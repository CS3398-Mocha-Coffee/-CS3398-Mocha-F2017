					  ...
					  <div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						  ...
						  <ul class="nav navbar-nav navbar-right">
							...
							<li><a href="#special">HOLIDAYS</a></li>
							<li><a href="#abouts">QUICK & EASY</a></li>
							<li><a href="#footer">MY PANTRY</a></li>
				...
				<div class="copyright_text_area">
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="single_footer text-right wow zoomIn" data-wow-duration="2s">
							<p>Made with <i class="fa fa-heart"></i> by <a>Team Mocha</a></p>
						</div>
					</div>
					<div class="col-md-6 col-sm-6 col-xs-12">
