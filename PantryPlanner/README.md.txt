...
***TODO Section***
Need to link both the recipe/pantry menu buttons to desired actions with the databases
Add exception handling to the GUI
Need to clear JTextArea on button click
Need to save JTextArea to specific array lists
